...
const StudentForm = () => {
      ...
      <div className="relative py-3 sm:max-w-xl sm:mx-auto">
        ...
        <div className="relative px-4 py-10 bg-gray-400 shadow-lg sm:rounded-3xl sm:p-20">
          <div className="max-w-md mx-auto">
            <div>
              <h1 className="text-2xl font-semibold">Student Information Form</h1>
            </div>
  ...
  />
                ...
                <div className="relative">
                  <label htmlFor="subjects" className="leading-7 text-sm text-gray-600">Subjects</label>
                  <input 
                    type="text" 
                    id="subjects" 
                    name="subjects" 
                ...
                <div className="relative">
                  <label htmlFor="school" className="leading-7 text-sm text-gray-600">Select School</label>
                  <select 
                    id="school" 
                    name="school" 
                    required 
                ...
                <div className="relative">
                  <button type="submit" className="bg-indigo-500 text-white rounded-md px-4 py-2 hover:bg-indigo-600 focus:outline-none focus:shadow-outline">
                    Submit
                  </button>
                </div>
              </form>
