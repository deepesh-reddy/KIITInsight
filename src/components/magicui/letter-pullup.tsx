  ...
  return (
    <div className="flex justify-center">
      ...
      <motion.h1
        ...
        className={cn(
          "font-display text-center text-3xl sm:text-5xl md:text-6xl lg:text-8xl xl:text-9xl font-bold tracking-[-0.02em] text-green-500 drop-shadow-sm dark:text-green-500 md:leading-[5rem]",
          className
        )}
      >
        KIIT
